...
class TestSpec:
    ...
    def test_original_metadata(self):
        ...
        assert np.isclose(original_metadata["WDF1"].pop("laser_wavenumber"), 30769.2)
        assert np.isclose(
            original_metadata_non_uniform["WDF1"].pop("laser_wavenumber"), 30769.2
        )
        expected_original_metadata = {
            ...
            "YLST": {"name": "Spatial_Y", "units": "px", "size": 1, "data": 25.0},
            "WXIS": {
            ...
            "WXDM": {"ExportToSPC": 1, "ExportToTXT": 1},
            "WXDA": {
            ...
            "WARP": {"ProcessingOperation": 1, "SpectrumIndex": -1},
            "WARP1": {"ProcessingOperation": 1, "SpectrumIndex": -1},
            "TEXT": "A single scan measurement generated by the WiRE spectral acquisition wizard.",
            "ORGN": {
                "Time": {
                    "units": "ns",
                    "annotation": "Time",
        ...
        assert original_metadata == expected_original_metadata
        assert original_metadata_non_uniform == expected_original_metadata
