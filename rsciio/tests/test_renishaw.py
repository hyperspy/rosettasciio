...
class TestSpec:
    ...
    def test_original_metadata(self):
        ...
        expected_original_metadata = {
            ...
            "WXDM_0": {"ExportToSPC": 1, "ExportToTXT": 1},
            "WXDA_0": {
            ...
            "WARP_0": {"ProcessingOperation": 1, "SpectrumIndex": -1},
            "WARP_1": {"ProcessingOperation": 1, "SpectrumIndex": -1},
            "TEXT_0": "A single scan measurement generated by the WiRE spectral acquisition wizard.",
            "ORGN_0": {
                "Time": {
                    "units": "ns",
                    "annotation": "Time",
